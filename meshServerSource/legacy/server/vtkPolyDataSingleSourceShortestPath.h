...
class vtkPolyDataSingleSourceShortestPath : public vtkPolyDataToPolyDataFilter
{
public:
	...
	// 2005.07.18 RFD: the confusing vtkGetObjectMacro(NAME, TYPE) refers to a vtk #define.
	// It creates a member of the form "[TYPE]* Get[NAME]()".
	...
	vtkGetObjectMacro(d, vtkDoubleArray);
