...
// VTK stuff
// Shouldn't this be <Common/mumble>, <Graphics/mumble> an
...
// ------------- standard configurations -------
	...
	#define _CPU	CPU_PENTIUM_II
#else
// The intel-specific optimizations (__INTEL__) are a nightmare 
// to manage on linux, so we leave them off on non-windows. 
