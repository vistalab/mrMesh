...
*   LINUX INSTRUCTIONS :
*
* Here, it is a little bit more compilcated because the compiler does 
* not understand the command pragma comment to include the libraries. You
* have to type :
*
*    mex smooth_mesh.cpp -IVTK_Include_Linux ...
*        VTK_Libs_Linux/libvtkCommon.a ...
*        VTK_Libs_Linux/libvtkFiltering.a ...
*        VTK_Libs_Linux/libvtkGraphics.a ...
*        VTK_Libs_Linux/libvtkPatented.a ...
*        VTK_Libs_Linux/libvtkCommon.a ...
*        VTK_Libs_Linux/libvtkFiltering.a
*        VTK_Libs_Linux/libvtkGraphics.a ...
*        VTK_Libs_Linux/libvtkPatented.a ...
*
* If you want to copy paste it here the same command in a single line :
* 
*    mex smooth_mesh.cpp -IVTK_Include_Linux VTK_Libs_Linux/libvtkCommon.a VTK_Libs_Linux/libvtkFiltering.a VTK_Libs_Linux/libvtkGraphics.a VTK_Libs_Linux/libvtkPatented.a VTK_Libs_Linux/libvtkCommon.a VTK_Libs_Linux/libvtkGraphics.a VTK_Libs_Linux/libvtkPatented.a VTK_Libs_Linux/libvtkFiltering.a
*
* You MUST add the libraries twice because they are interdependant and
* the compiler will refer to another library only if it is written after
* itself
*
* The libraries needed for this program to compile in linux
* are in the directory VTK_Libs_Linux
*
* The header files neede for this program to compile in linux
* are in the directory VTK_Include_Linux
*
***************************************************/
