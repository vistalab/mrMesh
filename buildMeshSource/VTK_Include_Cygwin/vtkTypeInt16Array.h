/*=========================================================================
  ...
  Module:    $RCSfile: vtkTypeInt16Array.h,v $
...
class VTK_COMMON_EXPORT vtkTypeInt16Array : public vtkUnsignedShortArray
{
public:
  static vtkTypeInt16Array* New();
  vtkTypeRevisionMacro(vtkTypeInt16Array,vtkUnsignedShortArray);
